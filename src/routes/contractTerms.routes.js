...
router.get('/sections', verifyToken, checkRole(['client']), (req, res) => {
  try {
...
router.post('/validate', verifyToken, checkRole(['client']), (req, res) => {
  try {
...
router.get('/parameters/:sectionTitle', verifyToken, (req, res) => {
  try {
